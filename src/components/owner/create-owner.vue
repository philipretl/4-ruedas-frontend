  ...
  <div class="modal flex h-screen w-full fixed top-0 left-0 right-0 flex justify-center bg-black bg-opacity-50 " :class="isVisible">
    ...
    <div class="bg-white rounded shadow-lg pl-12 pb-2 w-8/12 my-12 overflow-y-scroll pt-2" style="height: 70vh;">
      ...
      <div class="border-b px-4 py-2 flex justify-between items-center">
        <h3 class="font-semibold text-lg">Regitrar nuevo propietario</h3>
      ...
      <!-- modal body -->
      <form @submit.prevent = "registerOwner" class="w-full pt-12 max-w-lg  flex flex-col">
...
export default{
  ...
  methods:{
    cancel(){
      store.dispatch('owners/establishCreatingOwner', false);
    },
    registerOwner(){
      let owner = {
        'name': this.name,
      ...
      store.dispatch('owners/registerOwnerServer', owner);
    }
  }
}
</script>